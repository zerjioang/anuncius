...
<html lang="es">
    ...
    <head>
        <s:include value="/templates/metadata/metadata.generic.jsp">
            <s:param name="description" value="'Política de privacidad, LOPD (Ley Orgánica 15/1999, de 13 de diciembre, de Protección de Datos de datos) aplicada a de anuncius'"></s:param>
