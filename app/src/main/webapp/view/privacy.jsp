...
<html ⚡ lang="es">
    ...
    <body class="gl-realestate-template">
        ...
        <s:include value="/templates/modules/hero/hero.section.jsp">
            ...
            <s:param name="image" value="'http://static.anunci.us/img/hero/privacy/hero.jpg'" />
                                    ...
                                    <ul>
                                        <li>
                                            ...
                                            <ul>
                                                ...
                                                <li>
                                                    <a href="http://www.google.com/intl/en-US/policies/technologies/cookies/" target="_blank">
