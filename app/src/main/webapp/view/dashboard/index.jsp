...
-->
    <link rel="stylesheet" href="/theme/admin/dist/css/skins/skin-blue.min.css">
...
<body class="hold-transition skin-blue sidebar-mini">
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user user-menu">
                            ...
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                ...
                                <img src="/theme/admin/dist/img/user2-160x160.jpg" class="user-image" alt="User profile image">
                                <!-- hidden-xs hides the username on small devices so only the image appears. -->
                                <span class="hidden-xs" id="username">Sergio Anguita</span>
                            </a>
                            <ul class="dropdown-menu">
                                <!-- The user image in the menu -->
                                <li class="user-header">
                                    <img src="/theme/admin/dist/img/user2-160x160.jpg" class="img-circle" alt="User profile image">
                                    <p>
                                        Sergio
                                        <small>Miembro desde el 1 de enero del 2017</small>
                                    </p>
                                </li>
                                <!-- Menu Body -->
                                <li class="user-body">
            ...
            <section class="sidebar">
                ...
                <div class="user-panel">
                    <div class="pull-left image">
                        <img src="/theme/admin/dist/img/user2-160x160.jpg" class="img-circle" alt="Imagen de usuario">
                    </div>
   ...
   immediately after the control sidebar -->
        ...
        <!-- AdminLTE App -->
        <script src="/theme/admin/dist/js/app.min.js"></script>
