...
%>
    ...
    <%}else{%>
        ...
        <script async src="/theme/js/vendor/select2/select2.min.js"></script>
        ...
        <script src="/theme/js/app/reverser.js"></script>
    <%}%>
<% }else{ %>
    <%if(minified){%>
    ...
    <%}else{%>
        ...
        <script async src="https://static.anunci.us/theme/js/vendor/select2/select2.min.js"></script>
