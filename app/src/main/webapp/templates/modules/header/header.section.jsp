        ...
        <nav class="navbar gl-header-main-menu anuncius-bar" role="navigation">
            <div class="container bg-white">
                ...
                <div class="gl-extra-btns-wrapper">
                    <a href="#login" class="gl-add-post-btn" id="btn-header-login" style="background-color: #bababa; margin: 2px;">Mi cuenta</a>
                    <a href="#logout" class="gl-add-post-btn" id="session-logout" style="background-color: #bababa; margin: 2px;">Cerrar sesión</a>
                    <a href="/new" class="gl-add-post-btn" style="margin: 2px;">+ Publicar</a>
