<%-- 
    Document   : listview.map.right
    Created on : Dec 19, 2016, 5:40:50 PM
    Author     : sanguita
--%>
...
<head>
  ...
  <!-- PAGE TITLE -->
  <title>Glimpse - Listing Style Map Left</title>
...
<body class="gl-search-style-map-left gl-realestate-template">
      ...
      <div id="gl-result-section" class="gl-search-filter-result-wrapper">
        ...
        <div class="gl-search-filter-wrapper">
          <form action="#">
            ...
            <a href="#" class="gl-more-filter-btn">
              <span></span>
              <span></span>
              <span></span>
            </a>

            <div class="gl-advanced-search-wrapper">
              <div class="gl-filter-options gl-search-keyword">
                <input type="text" name="gl-search-tags" id="gl-search-tags" placeholder="Tags">
              </div>

              <div class="gl-range-wrapper">
                  <span class="gl-filter-inp-title">Price Range</span>
        ...
        <div class="gl-search-result-wrapper">
          <!-- FEATURED ITEMS -->
          <div class="gl-featured-items col-md-6 col-sm-12 col-xs-12 appear fadeIn" data-wow-duration=".5s" data-wow-delay=".3s">
          ...
          <!-- FEATURED ITEMS -->
          <div class="gl-featured-items col-md-6 col-sm-12 col-xs-12 appear fadeIn" data-wow-duration=".5s" data-wow-delay=".5s">
            <div class="gl-feat-items-img-wrapper">
              <picture>
