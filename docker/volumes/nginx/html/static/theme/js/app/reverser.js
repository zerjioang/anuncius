...
function codeAddress(data) {
    if (fromPlace == 1) {
    	...
    	//from street name to location
    	var address = "";
    	//generate address with given data.
    	if(data['state']!==undefined){
    		address = data['state']+", "+data['country'];
    	}
    	else{
...
function defaultMap() {
    ...
    document.getElementById("latlong").value = defaultLatLng.lat() + "," + defaultLatLng.lng();
