                    ...
                    <div class="col-md-12">
                        ...
                        <div class="header-items">
                            ...
                            <div class="header-text">
                                <h1><span>Smouq</span> the best<br>for enterprise communication.</h1>
                            </div><!-- header-text -->

                            <div class="header-buttons">
                                <a class="btn-white" href="login">Login</a>
                                <a class="btn-white-outlined" href="learn/more">Learn More</a>
                            </div><!-- header-buttons -->

                            <div class="app-image-container">
                                <img src="landing/images/header/shades.png" style="padding-top: 50px;" width="200" alt="smouq app logo">
